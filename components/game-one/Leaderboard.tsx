  ...
  return (
    <View style={styles.container}>
      ...
      <FlatList
        ...
        scrollEnabled={false} // Budući da je unutar ScrollView-a u glavnom ekranu
...
const styles = StyleSheet.create({
  container: { width: "100%", marginTop: 20, borderTopWidth: 1, borderTopColor: "#E5E7EB", paddingTop: 16 },
  ...
  rank: { width: 32, fontWeight: "700", color: "#111827" },
  username: { flex: 1, color: "#111827" },
  score: { fontWeight: "700", color: "#2563EB" },
