...
export default function GameOneScreen() {
  ...
  //stanja za bodovanje i leaderboard 
  ...
  const reloadComponent = () => {
    setRefreshKey(prevKey => prevKey + 1); // Osvježava Leaderboard 
  };

  // Timer za prikaz brojeva
  useEffect(() => {
  ...
  // Logika za provjeru i slanje bodova
  const handleSubmit = async () => {
    ...
    try {
      // Poziv servisa za ažuriranje bodova
      ...
      reloadComponent(); // Osvježi ljestvicu nakon spremanja [cite: 292]
    } catch (error: any) {
